      ...
      <div class="cs-invoice_in" id="download_section">
        <div class="cs-invoice_head cs-type1 cs-mb25">
          <div class="cs-invoice_left">
            <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Invoice No:</b> {{ $order_id }}</p>
            <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date: </b>{{ App\Models\Order::where('order_id', $order_id)->first()->created_at->format('d-M-Y') }}</p>
          </div>
        </div>
        <div class="cs-invoice_head cs-mb10">
          <div class="cs-invoice_left">
            ...
            <p>
              ...
              {{ App\Models\ShippingDetails::where('order_id', $order_id)->first()->address }} <br>{{ App\Models\City::where('id', $city_id)->first()->name }}, {{ App\Models\ShippingDetails::where('order_id', $order_id)->first()->zip }}, <br>
              {{ App\Models\Country::where('id', $country_id)->first()->name }}, <br>
            </p>
          </div>
          <div class="cs-invoice_right cs-text_right">
            ...
            <p>
              ...
              Email: {{ App\Models\BillingDetails::where('order_id', $order_id)->first()->email }} <br>
              T: {{ App\Models\BillingDetails::where('order_id', $order_id)->first()->mobile }}
            </p>
          </div>
        </div>
          ...
          <div class="cs-round_border">
            <div class="cs-table_responsive">
              <table>
                <thead>
                  <tr>
                    <th class="cs-width_6 cs-semi_bold cs-primary_color cs-focus_bg">Item</th>
                    ...
                    <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg">Subtotal</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    <td class="cs-width_6">{{ $product->rel_to_product->product_name }}</td>
                    <td class="cs-width_2">{{ $product->quantity }}</td>
                    <td class="cs-width_2 cs-text_right">{{ $product->price }} Tk</td>
                    <td class="cs-width_2">{{ $product->price * $product->quantity }} Tk</td>
                  </tr>
                  @endforeach
                ...
                <table>
                  <tbody>
                    <tr class="cs-border_left">
                      ...
                      <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ App\Models\Order::where('order_id', $order_id)->first()->subtotal }} Tk</td>
                    </tr>
                    <tr class="cs-border_left">
                      <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Dalivery Charge</td>
                      <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ App\Models\Order::where('order_id', $order_id)->first()->charge }} Tk</td>
                    </tr>
                    <tr class="cs-border_left">
                      <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Discount</td>
                      <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ App\Models\Order::where('order_id', $order_id)->first()->discount }} Tk</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <table>
                <tbody>
                  <tr class="cs-border_none">
                    ...
                    <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color cs-text_right">{{ App\Models\Order::where('order_id', $order_id)->first()->total }} Tk</td>
                  </tr>
                </tbody>
              </table>
            </div>
