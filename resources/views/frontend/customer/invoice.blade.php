                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  ...
                                  T: {{ App\Models\BillingDetails::where('order_id', $order_id)->first()->mobile }}<br>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  ...
                                  @endif
                                  <br>
                                  Transaction ID: <a href="#" style="color: #ff0000; text-decoration:underline;">
                                    @if ($payment_method == 1)
                                    NA
                                    @else
                                      {{ App\Models\Order::where('order_id', $order_id)->first()->transaction_id  }}
                                    @endif
                                  </a><br>
                                </td>
                              </tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  ...
                                  @endphp
                                  {{ App\Models\ShippingDetails::where('order_id', $order_id)->first()->address }}<br>
                                  {{ App\Models\City::where('id', $city_id)->first()->name }}<br>
                                  {{ App\Models\Country::where('id', $country_id)->first()->name }}<br>
                                  T: {{ App\Models\ShippingDetails::where('order_id', $order_id)->first()->mobile }}<br>
