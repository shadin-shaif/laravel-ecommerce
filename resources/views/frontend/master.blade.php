...
<meta name    = "viewport" content   = "width=device-width, initial-scale=1">
	...
	<style>
		...
		.color_id:checked~.form-option-label, .size_id:checked~.form-option-label {
			border-color: #121212;
			color       : #121212;
		}
       ...
       <div class                                                              = "preloader"></div>
        ...
        <div id                                                                = "main-wrapper">
						...
						<div class = "col-xl-5 col-lg-6 col-md-12 col-sm-12">
							...
							<div class = "currency-selector dropdown js-dropdown float-right mr-3">
								@auth('customerlogin')
									...
									@else 
									<a href = "{{ route('customer_register_login') }}"class = "text-muted medium"><i class = "lni lni-user mr-1"></i>Sign In / Register</a>
								@endauth
							</div>
						</div>
			...
			<img src   = "{{ asset('/frontend/img/logo.png') }}" class = "logo" alt = "" />
									...
									<input id    = "search_input" type           = "text" class       = "form-control custom-height b-0" placeholder               = "Search for products..." value = "{{ @$_GET['q'] }}" />
	...
	var     Tawk_API = Tawk_API||{}, Tawk_LoadStart = new Date();
		...
		var s1         = document.createElement("script"), s0 = document.getElementsByTagName("script")[0];
		    s1.async   = true;
		    s1.src     = 'https://embed.tawk.to/647a44a97957702c744b75e6/1h1upoe58';
		    s1.charset = 'UTF-8';
