        ...
        <ul class="nav">
			...
			<li class="nav-item">
			  <a href="{{ route('index') }}" class="nav-link">
				...
				<span class="link-title">Visite Website</span>
			  </a>
			</li>	
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#category" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
              <span class="link-title">category's</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="product">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ Route('brand') }}" class="nav-link">Product Brand</a>
                </li>                 
                <li class="nav-item">
		  ...
		  <li class="nav-item nav-category">Coupon</li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#coupon" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#orders" role="button" aria-expanded="false" aria-controls="emails">
              <i class="link-icon" data-feather="mail"></i>
            ...
            <div class="collapse" id="orders">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ Route('orders') }}" class="nav-link">Check Orders</a>
                </li>                                 
              </ul>
            </div>
          </li>
